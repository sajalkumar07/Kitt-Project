...
const FlightSearchFormModel: React.FC<FlightDetailsModalProps> = ({
  isOpen,
  onClose,
}) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 items-center justify-center  ${
        isOpen ? "bg-[#E6E8EB] bg-opacity-50" : ""
      }`}
    >
      <style jsx>{`
        @keyframes slideIn {
      ...
      <div
        className={` ${isAnimating ? (isOpen ? "slide-in" : "slide-out") : ""}`}
      >
        <div className="w-screen mx-auto">
          <form
            className="bg-white p-6 shadow-md rounded-md w-full h-[233px] border border-[#E6E8EB] "
          ...
          >
            ...
            <div className="flex flex-col items-center ">
              <div className="flex justify-center items-center gap-4 mb-6 ">
                <div className="w-full md:w-auto">
                  <label className="block mb-2 text-sm font-medium">
                    <div className="relative">
                      <CustomMarkerIcon />
                      <select
                        className="block w-full md:w-[267px] h-[60px] pl-10 pr-10 py-2 text-gray-700 bg-white border border-gray-300 rounded-md appearance-none"
                        required
                        value={from}
                ...
                <div className="w-full md:w-auto">
                  <label className="block mb-2 text-sm font-medium">
                    <input
                      type="date"
                      className="block p-2 border rounded-md w-full md:w-[177px] h-[60px]"
                      required
                      value={departureDate}
              ...
              <div className=" w-[68%] justify-end flex">
                <button
                  type="submit"
...
export default FlightSearchFormModel;
